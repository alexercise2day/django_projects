...
SECRET_KEY = "django-insecure-97mp0dmrv8(pe$c+m!54nxsiurxec!n*mew-)hyec#z5o@@k@a"
...
STATIC_ROOT = BASE_DIR / 'cocktail_book/productionfiles'
...
# Making sure that css file loads correctly on browser
